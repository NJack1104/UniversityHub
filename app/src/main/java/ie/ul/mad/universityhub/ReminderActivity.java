...
public class ReminderActivity extends BaseActivity {
        ...
        addTaskButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(TextUtils.isEmpty(enteredTask)){
                    Toast.makeText(ReminderActivity.this, "You must enter a task first", Toast.LENGTH_LONG).show();
                    return;
                }
                if(enteredTask.length() < 6){
                    Toast.makeText(ReminderActivity.this, "Task count must be more than 6", Toast.LENGTH_LONG).show();
                    return;
                }
    ...
    private void getAllTask(DataSnapshot dataSnapshot){
        for(DataSnapshot singleSnapshot : dataSnapshot.getChildren()){
            ...
            recyclerViewAdapter = new RecyclerViewAdapter(ReminderActivity.this, allTask);
